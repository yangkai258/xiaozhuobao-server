...
import { api_projects } from "../../api/client";
    ...
    <view v-else>
      ...
      <view class="dossier-section">
        <view class="dossier-section-head">
          <view class="dossier-section-mark"><IconBox name="rental" :size="14" color="var(--c-warn)"/></view>
          <text class="dossier-section-title">项目概览</text>
        </view>
        <view class="dossier-section-body">
          <view class="irow"><text class="ilabel">项目编号</text><text class="ival mono">{{ detail.no }}</text></view>
          <view class="irow"><text class="ilabel">项目名称</text><text class="ival">{{ detail.name }}</text></view>
          ...
          <view class="irow"><text class="ilabel">项目状态</text><text class="ival">{{ detail.status }}</text></view>
...
.dossier-cover::before { content: ""; position: absolute; left: 0; top: 0; bottom: 0; width: 3px; background: var(--mark-color, var(--c-warn)); }
